		...
		<form id="form-privilege"  class="form-horizontal"  name="editForm" action="{$form_action}" method="post" enctype="multipart/form-data" >
			<fieldset>
				<div class="control-group formSep">
					<label class="control-label">{lang key='notification::notification.label_name'}</label>
					<div class="controls">
				...
				<div class="control-group formSep">
					<label class="control-label">{lang key='notification::notification.label_desc'}</label>
					<div class="controls">
